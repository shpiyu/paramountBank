<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.beans.Transaction2"%>
...
<nav id="menu">
      ...
      <div class="wrapper">
        <div class="text-container">
            <h2>Fund transfered successfully :)</h2>
            <table>
            	<tr>
            	<td>From</td><td>To</td><td>Amount</td>
            	</tr>
            	
            	<tr>
            	<td><%=transaction.getFromAcc()%></td><td><%=transaction.getToAcc() %></td><td><%=transaction.getAmount()%></td>
            	</tr>
            </table> 
            <p>Your current balance is Rs <span><%=request.getAttribute("balance")%></span></p>
       
            <p>Go back to <a href="home.jsp" class="forward-link">home</a>.</p>
        </div>
      </div>
</body>
</html>