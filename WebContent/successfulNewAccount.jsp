<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.beans.Account, com.beans.User"%>
...
<nav id="menu">
      ...
      <div class="wrapper">
        <div class="text-container">
			...
			<p>Account No <%=account.getAccNo()%></p>
			<!--  <p>Account Type <%=account.getAccType()%></p>-->
			<p>Account Balance <%=account.getBalance()%></p>
